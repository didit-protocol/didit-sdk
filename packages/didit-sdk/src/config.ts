...
const DEFAULT_EMAIL_AUTH_LOGOUT_IFRAME_PATH = '/oidc/logout/iframe';
...
const EMAIL_AUTH_LOGOUT_POST_MESSAGE_TYPE = 'didit-auth-logout';
...
const DIDIT = {
  ...
  DEFAULT_EMAIL_AUTH_LOGOUT_IFRAME_PATH,
  ...
  EMAIL_AUTH_LOGOUT_POST_MESSAGE_TYPE,
